...
export const AI_CONFIG = {
  ...
  riskProfiles: {
    ...
    markov:       { hotBias: 0.35, coldBias: 0.15, diversityWeight: 0.5, sequencePenalty: 1.0 },
    momentum:     { hotBias: 0.5, coldBias: 0.1, diversityWeight: 0.4, sequencePenalty: 1.0 },
    harmonic:     { hotBias: 0.35, coldBias: 0.2, diversityWeight: 0.7, sequencePenalty: 1.5 },
    regression:   { hotBias: 0.15, coldBias: 0.35, diversityWeight: 0.6, sequencePenalty: 1.0 },
  },
