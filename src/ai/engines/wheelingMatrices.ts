...
export const WHEELING_MATRICES = {
  ...
  quina_12_4: {
    name: "Quina 12→Quadra",
    description: "12 dezenas-base → jogos de 5 com garantia de 4 acertos (Quadra) se os 5 sorteados estiverem na base",
    lottery: "quina",
    baseSize: 12,
    pick: 5,
    guarantee: 4,
    games: generateQuina12_4(),
  },
  duplasena_10_4: {
    name: "Dupla Sena 10→Quadra",
    description: "10 dezenas-base → jogos de 6 com garantia de 4 acertos (Quadra) se os 6 sorteados estiverem na base",
    lottery: "duplasena",
    baseSize: 10,
    pick: 6,
    guarantee: 4,
    games: generateDuplaSena10_4(),
  },
  timemania_15_7: {
    name: "Timemania 15→7pts",
    description: "15 dezenas-base → jogos de 10 com garantia de 7 acertos se os 10 sorteados estiverem na base",
    lottery: "timemania",
    baseSize: 15,
    pick: 10,
    guarantee: 7,
    games: generateTimemania15_7(),
  },
  lotomania_60_50: {
